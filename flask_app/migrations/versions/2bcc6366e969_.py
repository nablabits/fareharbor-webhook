...
Revision ID: 2bcc6366e969
Revises: 
Create Date: 2021-07-19 08:35:12.632692
...
def upgrade():
    ...
    op.create_table('checkin_status',
    ...
    sa.ForeignKeyConstraint(['affiliate_company_id'], ['company.id'], ),
    ...
    sa.ForeignKeyConstraint(['id'], ['booking.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['checkin_status_id'], ['checkin_status.id'], ),
    sa.ForeignKeyConstraint(['customer_type_rate_id'], ['customer_type_rate.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
